...
class Controller(object):
    def __init__(self, *args, **kwargs):
        ...
        self.sample_time = 1.0/args[10]# 1/sample_rate
    ...
    def control(self, *args, **kwargs):
        ...
        if args[4] :#if is_dbw_enabled
            ...
            if throttle < self.brake_deadband*-1:
                ...
                brake = (self.vehicle_mass + self.fuel_capacity * GAS_DENSITY) * brake * self.wheel_radius
                throttle = 0
            else : 
